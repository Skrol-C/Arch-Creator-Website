...
export const legal = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: 'legal.terms.sec.4', body: ['legal.terms.sec.4.p.0'] },
      { title: 'legal.terms.sec.5', body: ['legal.terms.sec.5.p.0'], list: ['legal.terms.sec.5.list.0', 'legal.terms.sec.5.list.1', 'legal.terms.sec.5.list.2'] },
      { title: 'legal.terms.sec.6', body: ['legal.terms.sec.6.p.0'] },
      { title: 'legal.terms.sec.7', body: ['legal.terms.sec.7.p.0'], note: 'legal.terms.sec.7.note' },
      ...
      { title: 'legal.terms.sec.12', body: ['legal.terms.sec.12.p.0'] },
    ],
  },
  privacy: {
  ...
  licenses: {
    ...
    table: {
      ...
      rows: [
        ...
        ['@freemius/checkout', 'MIT', '© Freemius Inc.'],
        ['@tauri-apps/plugin-fs', 'MIT / Apache-2.0', '© Tauri contributors'],
        ['@tauri-apps/plugin-http', 'MIT / Apache-2.0', '© Tauri contributors'],
        ['@iarna/rtf-to-html', 'ISC', '© Rebecca Turner'],
        ['docx', 'MIT', '© Dolan Miu'],
        ['jszip', 'MIT / GPL-3.0-or-later', '© Stuart Knightley'],
        ['mammoth', 'BSD-2-Clause', '© Michael Williamson'],
