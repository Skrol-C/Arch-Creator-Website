...
export const site = {
  ...
  discord: 'https://discord.gg/Ny4ugzJgD',
...
export const pricing = {
  ...
  compare: {
    ...
    matrix: {
      ...
      rows: [
        { label: 'No subscription', values: ['yes', 'yes', 'yes', 'some', 'no', 'some', 'no'] },
        { label: 'Offline desktop app', values: ['yes', 'yes', 'yes', 'yes', 'no', 'no', 'no'] },
        { label: 'Free tier to start', values: ['yes', 'no', 'yes', 'no', 'yes', 'yes', 'no'] },
        { label: 'Worldbuilding + writing in one', values: ['yes', 'some', 'yes', 'no', 'yes', 'yes', 'yes'] },
        { label: 'Continuity assistant', values: ['yes', 'no', 'no', 'no', 'no', 'no', 'no'] },
        { label: 'Data stays on your device', values: ['yes', 'yes', 'yes', 'yes', 'no', 'no', 'no'] },
        { label: 'Export .docx / .epub / .pdf', values: ['yes', 'yes', 'yes', 'some', 'some', 'yes', 'yes'] },
      ],
    },
    why: 'We are tired of renting the tools we love. Your world is yours — the software you build it in should be too.',
    footnote: 'Prices and feature cells checked against competitor sites, August 2026. Pricing is indicative and may change; please verify on the respective sites.',
  },
  requirements: [
...
export const contact = {
  ...
  emailLabel: 'Email',
  discordTitle: 'Join the studio on Discord',
  discordLed: 'Writers, worldbuilders and the Arch Studios team — share your worlds, get help, and peek at what is being built.',
}
